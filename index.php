...
try {
    ...
    foreach ($users as $u) echo "<tr><td>" . htmlspecialchars($u['username']) . "</td><td>" . htmlspecialchars($u['name']) . "</td></tr>";
    echo "</table>";
} catch (Exception $e) {
    echo "<p>DB not ready. <a href='init_db.php'>Run Setup</a></p>";
}
